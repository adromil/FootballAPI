...
//    NSString *key = [components[0] stringByReplacingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
      NSString *key = [self URLEncodeValue:components[0]];
    id value = nil;
...
//      value = [components[1] stringByReplacingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
        value = [self URLEncodeValue:components[1]];
...
- (NSString *)URLEncodeValue:(NSString *)string {
    //    NSString *result = (NSString *) CFBridgingRelease(CFURLCreateStringByAddingPercentEscapes(kCFAllocatorDefault, (CFStringRef)string, NULL, (CFStringRef)@"+", kCFStringEncodingUTF8));
...
//      value = [[self[key] description] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
        value = [self URLEncodeValue:[self[key] description]];
    }
